...
| `doc-review`, recommended — same section                                                                                | same marketplace: `/plugin install doc-review@asterism`                                                                   | no review reads a comment for whether it is still true, and the change reviewer fills the gap with wording notes |
