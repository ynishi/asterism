...
- [`schema`](schema.md): Schema artifact registry — the SDK-owned half of the "SDK =
- [`state`](state.md): Lifecycle state of a dispatch as seen by the exporter's
