...
- [`clone`](clone.md): Taking a copy of what a team holds (#148 decision 10).
...
- [`publish`](publish.md): Seeding a team's line from a private one (#148 decision 11).
