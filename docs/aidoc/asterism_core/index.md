...
- [`application::forge::legacy_pursuit_service`](application__forge__legacy_pursuit_service.md): `LegacyPursuitService` — the lifecycle verbs of the minted unit of work
