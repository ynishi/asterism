# asterism-core::application::provenance_service
...
- `ProvenanceService` — Assembles and applies AI-disclosure provenance.

## Traits

- `ProvenanceWriter` — Writes a disclosure into a file that already exists.
