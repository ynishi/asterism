# asterism-core::domain::forge::line
...
- `Line` — One named line of a project. v1 restricts a project to exactly one,
- `LineEntry` — The forge identity above raw asset ids (#63 decision 1). Deliberately
- `LineEvent` — One verb applied to one entry, filed under the merge that landed it.
- `LineVerb` — The closed set of merge verbs, payload included (#63 decision 2).
