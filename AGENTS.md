...
Claude Code reads `CLAUDE.md` rather than this name, so `.claude/CLAUDE.md` is a
symlink back to this file and the only thing under `.claude/` this repository
tracks. Nothing to wire up; nothing said twice.
