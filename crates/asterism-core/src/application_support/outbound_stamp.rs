...
pub trait OutboundStamping: Send + Sync {
    ...
    /// called, and what became of each file is recorded before this
    /// returns either way. What the caller does with it is the caller's,
    /// and the runner's own answer is beside the call it makes.
