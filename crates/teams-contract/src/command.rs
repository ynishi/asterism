...
//! admin or an operator's tooling calls.
//!
...
//! gave an owner a screen to say them from — the roster writes. What
//! stays here is what no client says at all: the substrate's own
//! upload.
//!
