...
use asterism_contract::command::{
    ...
    MergeAssetsCommand, MoveDirCommand, MoveGroupToDirCommand, OrganizeByLocationCommand,
    ...
    RenameGroupCommand, RenameSavedQueryCommand, RenameSessionCommand, ReorderGroupAssetsCommand,
